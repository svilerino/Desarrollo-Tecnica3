...
For byteX = 1 To Len(strEntrada) ' recorre desde el principio hasta el final de la oracion buscando a,e,i,o,u
    Select Case LCase(Mid(strEntrada, byteX, 1))
        Case Is = "a", "e", "i", "o", "u"
            byteCuentaVocales = byteCuentaVocales + 1 'si encuentra una , la cuenta
    End Select
Next byteX
End Function
...
For byteX = 1 To Len(strEntrada) 'recorre la oracion buscando consonantes
    Select Case LCase(Mid(strEntrada, byteX, 1))
        Case Is = "b", "c", "d", "f", "g", "h", "j", "k", "l", "m", "n", "p", "q", "r", "s", "t", "v", "w", "x", "y", "z"
            byteCuentaConsonantes = byteCuentaConsonantes + 1 ' si las encuentra las cuenta
    End Select
Next byteX
End Function
...
Dim byteX As Byte
byteCuentaPalabras = 1 ' pone el contador en 1, dado que las palabras son cantidad de espacios +1
For byteX = 1 To Len(strEntrada) ' recorre la palabra buscando espacios
    If Mid(strEntrada, byteX, 1) = " " Then byteCuentaPalabras = byteCuentaPalabras + 1 'si los encuentra suma 1
Next byteX
End Function
